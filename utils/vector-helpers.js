...
export const getMagnitude = (vector: VectorType): number => Math.sqrt(vector.x * vector.x + vector.y * vector.y);
...
export const getAngle = (vector: VectorType): number => Math.atan2(vector.y, vector.x);
